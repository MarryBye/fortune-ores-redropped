...
- Drop replacement lives in the static `OreSwapper.swapDrops(...)`; silk touch is preserved, non-block drops pass through, and XP is spawned from the matched ore entry.
